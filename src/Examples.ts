...
// @ts-ignore
import quantum_harmonic_oscillator_coherent_state_1d from "./examples/quantum-harmonic-oscillator-coherent-state-1d.json";
// @ts-ignore
...
// @ts-ignore
import quantum_pauli_y_gate from "./examples/quantum-pauli-y-gate.json";
// @ts-ignore
...
// @ts-ignore
import heat_map_dynamic from "./examples/heat-map-dynamic.json";
// @ts-ignore
...
// @ts-ignore
import stacked_area_plot from "./examples/stacked-area-plot.json";
// @ts-ignore
...
// @ts-ignore
import array_inputs from "./examples/array-inputs.json";
// @ts-ignore
...
export class Examples {
  ...
  constructor() {
    ...
    this.files.push({name: "Statistics: Stacked Area Plot", data: stacked_area_plot});
    ...
    this.files.push({name: "Quantum Mechanics: Coherent State", data: quantum_harmonic_oscillator_coherent_state_1d});
    ...
    this.files.push({name: "Quantum Computing: Pauli-Y Gate", data: quantum_pauli_y_gate});
