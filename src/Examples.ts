...
export class Examples {
  ...
  constructor() {
    ...
    this.files.push({name: "Numerical Simulation: Finite Difference Method", data: pde_fdm_solver});
    this.files.push({name: "Numerical Simulation: Numerical Stability", data: pde_numerical_stability});
    this.files.push({name: "Numerical Simulation: Heat Equation", data: heat_equation});
