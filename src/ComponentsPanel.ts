...
export class ComponentsPanel {
  ...
  getUi(): string {
    return `<h2 style="text-align: center; font-size: 16px; vertical-align: top; margin-top: 0; margin-bottom: 10px">
            ...
            <div id="components-scroller" style="overflow-y: auto; height: 400px; margin-top: 0; border-bottom: 2px solid lightgray; border-top: 2px solid lightgray">
              <h3 style="text-align: left; font-size: 14px;"><span style="font-size: 1.2em; color: teal; vertical-align: middle"><i class="fas fa-cube"></i></span> Microcontrollers</h3>
              ...
              <h3 style="text-align: left; font-size: 14px;"><span style="font-size: 1.2em; color: teal; vertical-align: middle"><i class="fas fa-cube"></i></span> HATs</h3>
              ...
              <div class="vertical-divider"></div>
              <h3 style="text-align: left; font-size: 14px;"><span style="font-size: 1.2em; color: teal; vertical-align: middle"><i class="fas fa-cube"></i></span> Others</h3>
